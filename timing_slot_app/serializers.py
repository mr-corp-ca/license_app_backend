...
class GETMonthlyScheduleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MonthlySchedule
        fields = ['id', 'date', 'start_time', 'end_time', 'launch_break_start', 'launch_break_end', 'extra_space_start', 'extra_space_end', 'vehicle', 'day_name', 'lesson_gap', 'lesson_duration', 'extra_space_end']
