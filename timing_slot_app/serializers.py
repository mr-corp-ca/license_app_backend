...
class MonthlyScheduleSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['date', 'start_time', 'end_time', 'launch_break_start', 'launch_break_end', 'extra_space_start', 'extra_space_end', 'vehicle', 'lesson_gap', 'lesson_duration', 'extra_space_end']
