    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Owner Admin'), ('learner', 'Learner'), ('instructor', 'Instructor'), ('school', 'School')], max_length=255)),
                ...
                ('user_status', models.CharField(blank=True, choices=[('pending', 'Pending'), ('accepted', 'Accepted'), ('rejected', 'Rejected')], default='pending', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noti_type', models.CharField(choices=[('general', 'General')], max_length=255)),
